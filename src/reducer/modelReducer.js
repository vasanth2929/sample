...
import { DELETE_ALL_INSTANCES, DELETE_INSTANCE, SAVE_ALL_INSTANCES, SAVE_INSTANCE } from '../constants/general';
...
export default function modelReducer(state = OrderedMap({}), action) {
    switch (action.type.split('/')[0]) {
        case SAVE_INSTANCE: {
            ...
            if (storedInstance) {
                instance.props = objectAssign({}, storedInstance.props, instance.props, { props: { editMode: action.editMode } });
            }

...
import {
  ...
  saveInstance,
  saveLast
} from "../action/modelActions";
import { INVALID_INSTANCE_CANNOT_SAVE } from "../constants/general";
import store from "../util/store";
import { contains, isEmpty, keys } from "../util/utils";
...
export class BaseModel {
  ...
  /**
   * Used to fetch single instance from the store.
   * @param ids the list of ids of the instances which need to be fetched.
   */
